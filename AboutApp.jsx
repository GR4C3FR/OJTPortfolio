...
function AboutApp() {
  return (
    <Container>
      ...
      <TemporaryText>
        <p>
          Iâ€™m all about building <strong>clean, beautiful digital experiences</strong> that just work on any screen. My favorite part of the job is taking messy ideas and turning them into polished, easy-to-use interfaces and layouts that are simple, purposeful, and intuitive to navigate.
        </p>
        <p>
          Iâ€™m constantly working to sharpen my design eye. Right now, that means messing around with new tools, figuring out how to make things as smooth as possible for the user, and obsessing over the little things, like getting the spacing exactly right, making sure fonts look great, and picking the perfect vibe for the visuals. Plus, since I have a <strong>background in front-end development</strong>, I actually understand how things get built under the hood. That helps me design stuff that isn't just pretty, but is actually <strong>practical to develop</strong>.
        </p>
        <p>
          I really thrive in collaborative spaces where I can bounce ideas around, take constructive feedback, and iterate fast to make something awesome. Right now, Iâ€™m looking to <strong>jump into real-world projects</strong>, whether thatâ€™s freelance gigs, internships, or teaming up with a crew, where I can pitch in, grow my skills, and help build things people actually enjoy using.
        </p>
      </TemporaryText>
    </Container>
  )
